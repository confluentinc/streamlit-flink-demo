...
class Result(Container):
  ...
  def prepare(self, changelog):
    # Prepare the changelog table
    self.changelog = changelog
    self.changelog_dt.add_columns(*changelog.columns)
    self.changelog_dt.visible = True
    # Prepare the collapsed changelog table
    collapsed = changelog.collapse()
    self.table_dt.add_columns(*collapsed.columns)
    self.collapsed = collapsed
    self.table_dt.visible = True
